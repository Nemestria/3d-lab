...
useFrame((state, delta) => {
  ...
  return <mesh ref={ref} onPointerDown={(e) => { e.stopPropagation(); dragging.current = true }}><sphereGeometry/><MeshTransmissionMaterial thickness={thickness} roughness={roughness} ior={ior} chromaticAberration={chromaticAberration}
/></mesh>
}
      ...
      >
        ...
        <Suspense fallback={null}>
          ...
          position={[0, 0, -2]}>
            ...
            <Orb thickness={thickness} roughness={roughness} ior={ior} chromaticAberration={chromaticAberration}>
            </Orb>
        </Suspense>
